...
2019-10-05 JJK  Don't worry about Spotify for now, just get a localhost
                web server running (for testing using Express)
=============================================================================*/
...
var webServer;
// If running local server just use HTTP
webServer = new http.createServer(app)
    .listen(process.env.WEB_PORT, function () {
      console.log("HTTP server, Live at Port " + process.env.WEB_PORT + " - Let's rock!");
});
